                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="billing-details">
                                    <form action="{{ url('buyer-profile/change-profile') }}" method="POST">
                                        @csrf
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle pl-4">{{ $user->email }}<a
                                                        href="{{ url('buyer-profile/change-email') }}" class="ml-2"><i
                                                            class="fa fa-fw fa-pencil-square-o"></i>Ubah</a></td>
                                            </tr>
                                            <tr>
                                                <td class="text-right align-middle text-gray">Password</td>
                                                <td class="align-middle pl-4">********** <a href="{{ url('buyer-profile/change-password') }}"
