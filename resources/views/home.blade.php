                                ...
                                <div class="products-slick" data-nav="#slick-nav-1">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="img-product-upload/{{ $product_images[$i] }}" alt="">
                                        ...
                                        <div class="product-body">
                                            <p class="product-category">{{$categories[($product->category_id)-1]->name}}
                                            </p>
                                            <h3 class="product-name"><a
                                                    href="detail-product/{{$product->id}}">{{ $product->name }}</a></h3>
